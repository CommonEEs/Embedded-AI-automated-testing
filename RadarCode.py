...
dataset_url = "/home/jorge/Vitis-AI/examples/VART/resnet50_tensorflow/RadarSet"
...
testdatadir = pathlib.Path("/home/jorge/Vitis-AI/examples/VART/")
testdir = list(testdatadir.glob('Full RadarSet/*.jpg'))
